...
public class PlacesFragment extends BaseFragment {
    ...
    private RelativeLayout myLayout1, myLayout2, myLayout3;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (!TextUtils.isEmpty(data2)&& !TextUtils.isEmpty(mylatlon2))
        {
            ...
            myLayout1 = (RelativeLayout) view.findViewById(R.id.my_layout1);
            testBut1.setVisibility(Button.GONE);
            myLayout1.setVisibility(RelativeLayout.VISIBLE);
        ...
        if (!TextUtils.isEmpty(data3)&& !TextUtils.isEmpty(mylatlon3))
        {
            ...
            myLayout2 = (RelativeLayout) view.findViewById(R.id.my_layout2);
            testBut2.setVisibility(Button.GONE);
            myLayout2.setVisibility(RelativeLayout.VISIBLE);
        ...
        if (!TextUtils.isEmpty(data4)&& !TextUtils.isEmpty(mylatlon4))
        {
            ...
            myLayout3 = (RelativeLayout) view.findViewById(R.id.my_layout3);
        ...
        public void onClick(View v) {
            switch (v.getId())
            {
                case R.id.close1:
                {
                    ...
                    myLayout1.setVisibility(RelativeLayout.GONE);
                    break;
                }
                case R.id.close2:
                {
                    ...
                    myLayout2.setVisibility(RelativeLayout.GONE);
                    break;
                }
                case R.id.close3:
                {
